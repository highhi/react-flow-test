...
var Root = function (_Component) {
  ...
  _createClass(Root, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('https://api.github.com/users').then(function (r) {
        return r.json();
      }).then(function (r) {
        var users = r.map(function (u) {
    ...
    value: function render() {
      return _react2.default.createElement(Users, { users: this.state.users });
    }
  }]);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.users.map(function (user, i) {
          return _react2.default.createElement(User, { key: i, user: user });
        })
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: user.img, alt: user.name })
        ),
        user.name
      );
    }
...
},{"react":159,"react-dom":30,"whatwg-fetch":160}],2:[function(require,module,exports){
(function (process){
/**
